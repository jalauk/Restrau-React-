...
import API from "../BreakApi";
import { Link } from "react-router-dom";
import Tooltip from "@mui/material/Tooltip";

const Breakfast = ({ setChoose }) => {
  ...
  return (
    <>
      <div className="mainDiv">
        <h1 className="head mt-3">BreakFast</h1>
      </div>
                      ...
                      <div class="p-6">
                        ...
                        <Link to="/view">
                          <Tooltip title="View More">
                            <Link to="/view">
                              <h1
                                class="title-font text-lg font-medium text-black-900 mb-3"
                                onClick={handleClick}
                              >
                                {e.name}
                              </h1>
                        ...
                        <div class="flex items-center flex-wrap ">
                          <a class="text-indigo-500 inline-flex items-center a1 md:mb-2 lg:mb-0">
                            Order Now
                            <svg
                              class="w-4 h-4 ml-2"
                              viewBox="0 0 24 24"
