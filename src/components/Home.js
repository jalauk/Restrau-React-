...
import Order from './ViewMore'
// import * as React from 'react';
import Tooltip from '@mui/material/Tooltip';
import Typography from '@mui/material/Typography';


const Home = ({setChoose}) => {
    ...
    return (
        <>
           <div className="mainDiv"><h1 className="head mt-3">Order Your Favourite</h1></div>
                            ...
                            <div class="p-4 item md:w-1/4">
                                <div class="h-full border-2 car border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                    ...
                                    <div class="flex items-center flex-wrap ">
                                        <Link to='/order' class="text-indigo-500 inline-flex items-center a1 md:mb-2 lg:mb-0">Order Now
